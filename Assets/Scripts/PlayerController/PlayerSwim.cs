...
{
    [Header("Properties")]
    [SerializeField] [Range(1, 10)] private float swimMovementSpeed = 7.0f;
    ...
    private bool HeadWaterCheck()
    {
        ...
        if(Physics.SphereCast(transform.position, controller.radius, Vector3.up, out RaycastHit hitInfo, rayLength))
        {
